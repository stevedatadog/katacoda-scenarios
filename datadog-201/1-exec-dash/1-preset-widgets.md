...
1. If your browser window is wide enough, you will see a **High Density Mode** control in the upper-right corner of the dashboard page. If so, click it and select **Normal Density Mode**:
